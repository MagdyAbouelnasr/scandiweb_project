...
const ProductCard = ({ id, sku, name, price, product_attribute, typeValue, selectedProducts }) => {
  ...
  return (
    <>
      <CardContent>
        <CardActions>
          <IconButton aria-label="select to delete" className={ isActive ? "delete-checkbox-selected" :           <IconButton aria-label="select to delete" className={ isActive ? "delete-checkbox-selected" : null} onClick={selectedProduct}>
