  ...
  return (
    <Box sx={{m:2, minWidth: 270, maxWidth: 270 }}>
      <Card variant="outlined">
        <ProductCard selectedProducts id={product.id} sku={product.sku} name={product.name} price={product.price} product_attribute={product.product_attribute} typeValue={product.product_attribute_value} />
      </Card>
    </Box>
  );
};
