...
function ProductAdd() {
  return (
    <div className="container">
      <div className="row">
      <h1 className="page-header text-header col-8">Product Add</h1>
      <div className='col-4 gap-2'>
        <Button className='p-2 mx-2 g-col-2' variant="primary" size="sm">
          Add
        </Button>
        <Button className='p-2 mx-2 g-col-2' variant="secondary" size="sm">
          Cancel
        </Button>
      </div>
      </div>
    ...
    <div className="col-md-5 mx-aut2o">
