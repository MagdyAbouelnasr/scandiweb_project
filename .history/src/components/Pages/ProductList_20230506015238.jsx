                ...
                <div className="d-inline-flex p-2 flex-wrap mt-2">

                    {
                        products.map((product, key) => (
                            ...
                            <Product key={product.id} className="" sku={product.sku} name={product.name} price={product.price} product_attribute={product.product_attribute} typeValue={product.product_attribute_value} />
