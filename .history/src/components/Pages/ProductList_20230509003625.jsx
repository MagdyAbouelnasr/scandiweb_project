            ...
            <div className="flex mt-5">
                <div className="row">
                    ...
                    <div className='col-4 float-end'>
                        ...
                        <Button onClick={() => { selectedProducts.forEach(product => deleteProduct(products.id))}} id="delete-product-btn" className='p-2 ms-2' variant="secondary" size="sm">
                            Mass Delete
                        </Button>
                    </div>
                </div>
                ...
                <div className="d-inline-flex p-2 flex-wrap mt-2">

                    {
                        products.map((product, key) => (
                            ...
                            <Product selectedProducts={setSelectedProducts} key={product.id} className="" product={product} />
