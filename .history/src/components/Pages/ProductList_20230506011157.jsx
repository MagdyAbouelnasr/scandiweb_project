            ...
            <div className="flex mt-5">
                ...
                <div className="d-inline-flex p-2 flex-wrap mt-2">
...

                    {
                        ...
                        <Product key={key} className="" sku={product.sku} name={product.name} price={product.price} product_attribute={product.type} typeValue={product.product_attribute_value} />
