import { useEffect , useSa} from "react";
            ...
            <div className="flex mt-5">
                ...
                <div className="d-inline-flex p-2 flex-wrap mt-2">
...

                    {
                        ...
                        <Product key={key} className="" sku={product.sku} name={product.name} price={product.price} type={product.type} typeValue={product.value} />
