...
function ProductAdd() {
  return (
    <div className="container">
      <div className="row">
      <h1 className="page-header text-header col-10">Product Add</h1>
      <Button className='col-1 mr-1' as="input" type="submit" value="Add" />
      <Button className='col-1'as="input" type="reset" value="Cancel" />
      </div>
